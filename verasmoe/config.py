...
class VeraConfig(PeftConfig):
    ...
    Args:
        ...
        num_experts (`int`):
            The number of experts to create when apply SMoE in VeRA.
        top_k (`int`):
            The top_k experts to use when apply SMoE
    """
    ...
    num_experts: int = field(default=4, metadata={"help": "Number of experts for vector b and vector d"})
    top_k: int = field(default=1, metadata={"help": "The top_k experts to use"})
